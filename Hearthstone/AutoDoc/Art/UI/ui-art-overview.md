...
**风格说明**：竖向轻薄拱形红金/蓝金阵营卡框、窄暖金金属包边、低明度宽裕说明区和宝石质感属性徽章；装饰细节集中在边缘，卡面中央为原画与文字保留清晰空间。

**适用范围**：当前战斗界面、备战界面及两者卡牌。
...
| 备战界面 | 展示本轮奖励、`01~98` 固定卡池和三个战斗槽，并支持拖放编成 | 暖色羊皮纸上区、深蓝卡池、红金标题与分隔装饰、纵向滚动条、固定空卡位和槽位高亮 | `UI-STYLE-001` | 卡面边框、卡牌编号六边形框、攻击力红金外框、生命值血滴徽章、卡牌原画 | `Assets/Resources/Art/Preparation/UI/*.png` 共 11 张专属页面与交互 Sprite |
