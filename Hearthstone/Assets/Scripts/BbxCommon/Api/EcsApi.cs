...
namespace BbxCommon
{
    public static class EcsApi
    {
        ...
        /// <summary>
        /// Removes the GameObject binding without destroying the bound object.
        /// Use this before returning a reusable GameObject to a pool.
        /// </summary>
        public static GameObject UnbindGameObject(this Entity entity)
        {
            if (!entity.HasRawComponent<GameObjectRawComponent>())
                return null;

            var gameObject = entity.GetRawComponent<GameObjectRawComponent>().GameObject;
            entity.RemoveRawComponent<GameObjectRawComponent>();
            return gameObject;
        }
        ...
        public static bool GetEntity(EntityID entityID, out Entity entity)
        {
            return EcsEntityManager.GetEntityByID(entityID, out entity);
        }
