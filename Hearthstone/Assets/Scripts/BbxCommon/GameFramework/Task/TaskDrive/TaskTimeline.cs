    ...
    public class TaskTimeline : TaskBase
    {
        ...
        private bool UpdateChild()
        {
            ...
            for (int i = 0; i < m_RunningTaskIndexes.Count; i++)
            {
                ...
                if (taskInfo.EndTime > 0 && taskInfo.EndTime < m_ElapsedTime)
                {
        ...
        protected override void OnTaskCollect()
        {
            ...
            // Timeline items reference nodes owned and collected by the root
            // task graph. Only clear the references here.
            m_TaskInfos.Clear();
        }
        #endregion
