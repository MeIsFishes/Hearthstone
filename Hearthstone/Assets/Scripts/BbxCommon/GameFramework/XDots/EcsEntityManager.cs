...
namespace BbxCommon
{
    internal static class EcsEntityManager
    {
        ...
        private static Dictionary<string, UniqueIdGenerator> m_IdGenerators = new();
        private static Dictionary<string, Dictionary<EntityID, Entity>> m_EntityByGroup = new();
        ...
        internal static void ResetEntitiesByGroup(string group)
        {
            ...
            {
                var entities = new List<Entity>(groupDic.Values);
