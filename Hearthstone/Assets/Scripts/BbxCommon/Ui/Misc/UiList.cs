...
{
    public class UiList : BbxUiItem, IUiPreInit, IUiInit, IUiOpen, IUiShow, IUiHide, IUiClose, IUiDestroy, IUiUpdate
    {
        #region Wrapper
        /// <summary>
        /// Functions for getting, adding and removing items.
        /// </summary>
        public ItemWpData ItemWrapper => new ItemWpData(this);
        ...
        public enum EArrangement
        {
            ...
            AreaFit,
            /// <summary>
            /// Only manage item lifecycle. Item positions are controlled by the caller.
            /// </summary>
            Manual,
        }
        ...
        [InfoBox("ConstantSlot: Set items to calculated positions, without any fix." +
            ...
            "\nManual: Only manage item lifecycle and preserve positions assigned by callers.")]
        ...
        /// <summary>
        /// Reapply the configured automatic layout. Manual lists preserve caller-assigned positions.
        /// </summary>
        ...
        private void CancelTranslations()
        {
            if (m_InTranslationItemIndexes == null || m_InTranslationItemIndexes.Count == 0)
                return;
            m_InTranslationItemIndexes.Clear();
            for (int i = 0; i < m_UiItems.Count; i++)
            {
                var item = m_UiItems[i];
                item.IsInTranslation = false;
                item.TranslationElapsedTime = 0f;
                m_UiItems[i] = item;
            }
        }
