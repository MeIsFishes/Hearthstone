...
namespace BbxCommon.Ui
{
    ...
    {
        #region Wrapper
        public PosWpData PosWrapper => new PosWpData(this);
        public RotWpData RotWrapper => new RotWpData(this);
        public ScaleWpData ScaleWrapper => new ScaleWpData(this);
        ...
        #region Common
        [SerializeField]
        [Tooltip("To avoid redundant UiTransformSetters, all UiTransformSetters will be removed by UiViewBase.PreUiInit," +
