...
namespace __PROJECT_NAMESPACE__
{
    ...
    public static class PlaceholderStages
    {
        ...
        public static GameStage CreateBaseStage(__PROJECT_NAME__GameEngine engine)
        {
        ...
        private static void TryAddPlaceholderUi(__PROJECT_NAME__GameEngine engine, GameStage stage)
        {
